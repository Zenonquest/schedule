...
# ###SHOULD TRY TO FIGURE OUT INHERITENCE
# class OpenEvent(models.Model):
# 	openevent_id = models.AutoField(primary_key=True)
# 	# id=models.IntegerField(default=0)
# 	start_datetime = models.DateTimeField('Start Date', default=timezone.now)
# 	end_datetime = models.DateTimeField('End Date', default=timezone.now)
# 	duration = models.FloatField(default=0)
...
# 	def __repr__(self):
# 		return '<OpenEvent %s, %s, %s>' % (self.teacher, self.student, self.start_datetime)
